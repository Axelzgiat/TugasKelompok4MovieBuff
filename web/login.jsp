<%-- 
    Document   : login
    Created on : 13-Dec-2018, 22:29:46
    Author     : Alexander
--%>
...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bioskopku","root", "");
    Statement st = con.createStatement();
    ResultSet rs;
    rs = st.executeQuery("select * from pemesan where username='" + userid + "' and password='" + pwd + "'");
    if (rs.next()) {
	...
	<div class="full">
		...
		<div class="header">
			...
			<div class="header-info">
				...
				<a class="book" href="login_member.jsp"><i class="book1"></i>BOOK TICKET</a>
			</div>
		</div>
		...
		<div class="news">
			<div class="col-md-6 news-left-grid">
				...
				<a href="login_member.jsp"><i class="book"></i>BOOK TICKET</a>
